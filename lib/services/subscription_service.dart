...
class SubscriptionService {
  ...
  Future<Map<String, dynamic>> createSubscription(String userId) async {
    try {
      ...
      final response = await http.post(
        ...
        body: jsonEncode({'userId': userId, 'planType': 'monthly'}),
      );
  ...
  void openCheckout({
    ...
    var options = {
      'key': 'rzp_test_SJ6tWDgkN7RRiB', // Razorpay test key
          ...
          if (data['success'] == true) {
            ...
            try {
              ...
              if (statusData['isPremium'] == true) {
                ...
                print(
                  '⚠️ Warning: Premium status not yet updated on server, but verification succeeded',
                );
              }
            } catch (e) {
